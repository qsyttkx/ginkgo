...
Test02::Test02(Scene* menu)
{
    ...
    // 初始化标题标签
    title = new Label("02. Graphical User Interface Test (Node based)", FontStyle(32));
    addChild(title);
...
void Test02::setLabels()
{
    ...
    auto root = new Node();
    addChild(root);
    root->setPosition(-300.0f,0);
    root->setRotation(0,-glm::radians(15.0f),0);
    ...
    for(int i = 0;i<6;++i)
    {
        ...
        labels[i]->setShader(shader1);
        root->addChild(labels[i]);
    }
}
...
void Test02::setButtons()
{
    ...
    {
        std::stringstream ss;
        ss<<"btn1 clicked! key: "<<key<<", mods: "<<mods;
        cout<<ss.str()<<endl;
        hint->setText(ss.str());
    };
    btn1->setPosition(960,400);
    ...
    {
        std::stringstream ss;
        ss<<"btn2 clicked! key: "<<key<<", mods: "<<mods;
        cout<<ss.str()<<endl;
        hint->setText(ss.str());
    };
    btn2->setPosition(960,300);
    ...
    {
        std::stringstream ss;
        ss<<"btn3 clicked! key: "<<key<<", mods: "<<mods;
        cout<<ss.str()<<endl;
        hint->setText(ss.str());
    };
    btn3->setPosition(960,200);
